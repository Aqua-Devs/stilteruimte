      ...
      <nav className="border-b border-sage/20 bg-white/50 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-8">
            ...
            <Link href="/journal/new" className="text-warm-gray hover:text-deep-sage transition-colors">
              Nieuw dagboek
            </Link>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="bg-white/60 backdrop-blur-md border border-sage/20 rounded-3xl p-8">
          <div className="flex justify-between items-center mb-8">
            <h2 className="font-serif text-3xl font-light text-soft-black">
              Recente entries
            </h2>
            ...
            <div className="space-y-4">
              {entries.map((entry) => (
                <Link
                  ...
                  className="block p-6 bg-white rounded-2xl border border-sage/10 hover:border-sage/30 hover:shadow-md transition-all"
                >
                  ...
                  <p className="text-warm-gray line-clamp-3">
                    {entry.content}
                  </p>
                </Link>
              ))}
          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-warm-gray mb-6">
                Wil je hulp bij het verwerken van je gedachten? Onze AI kan je zachtmoedig begeleiden door moeilijke momenten.
              </p>
              <Link
                href="/ai-companion"
                className="inline-block px-6 py-3 bg-sage text-white rounded-full hover:bg-deep-sage transition-all"
              >
                Start een gesprek
              </Link>
            </div>
